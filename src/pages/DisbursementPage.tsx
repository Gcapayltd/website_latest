...
import { ArrowRight, Send, Banknote, Users, Building2, Zap, Shield, BarChart3, Smartphone, Clock, FileText, Lock } from 'lucide-react';
...
export function DisbursementPage() {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(useCasesRef.current?.children || [],
        { y: 30, opacity: 0 },
        { 
          y: 0, 
          opacity: 1,
  ...
  const features = [
    { icon: Zap, title: 'Instant Payouts', description: 'Send money to mobile wallets in real-time, 24/7' },
    { icon: Shield, title: 'Fraud Protection', description: 'Built-in security checks for every transaction' },
    { icon: BarChart3, title: 'Bulk Disbursement', description: 'Process thousands of payouts at once with CSV upload' },
  ];
  ...
  const useCases = [
    {
      icon: Users,
      title: 'Payroll',
      description: 'Pay your employees directly to their mobile wallets. Schedule recurring payments and manage your entire workforce payroll from one dashboard.',
    },
    {
      icon: Banknote,
      title: 'Vendor Payments',
      description: 'Automate payments to suppliers and vendors. Set up approval workflows and track every payment with detailed reporting.',
    },
    {
      icon: FileText,
      title: 'Commission Payouts',
      description: 'Pay agents, affiliates, and partners instantly. Perfect for gig economy platforms, delivery services, and sales teams.',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#0B0B0D]">
      ...
      {/* Hero Section - Classical Style */}
      <section className="relative pt-32 pb-20 px-6 lg:px-[8vw] min-h-[70vh] flex items-center">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div ref={heroRef}>
              ...
              <h1 className="text-[clamp(36px,5vw,64px)] font-bold leading-tight tracking-[-0.02em] text-[#F4F1EC] mb-6">
                Disbursement <span className="text-[#C9A45C]">API</span>
              </h1>
              <p className="text-xl text-[#A9A6B0] mb-8 max-w-xl">
                Send money to mobile wallets and bank accounts instantly. Power your payroll, vendor payments, and commission payouts with our reliable payout infrastructure.
              </p>
      ...
      <section className="py-20 px-6 lg:px-[8vw]">
        <div className="text-center mb-16">
          ...
          <h2 className="text-[clamp(28px,3.5vw,44px)] font-bold text-[#F4F1EC] mb-4">
            Send money <span className="text-[#C9A45C]">anywhere</span>
          </h2>
          <p className="text-lg text-[#A9A6B0] max-w-2xl mx-auto">
            Disburse funds to mobile wallets and bank accounts across Tanzania.
          </p>
        </div>

        <div ref={channelsRef} className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Mobile Money - Active */}
          <div className="relative group">
            ...
            <div className="relative bg-gradient-to-br from-[#1a1a20] to-[#141419] border-2 border-[#C9A45C]/40 rounded-3xl p-8 h-full">
              ...
              <p className="text-[#A9A6B0] mb-6">Send instant payouts to all major mobile money providers in Tanzania.</p>

              <div className="flex items-center gap-4 pt-6 border-t border-[#2a2a30]">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-[#141419]/80 border border-[#2a2a30] rounded-3xl p-8 h-full overflow-hidden">
              ...
              <div className="absolute inset-0 bg-[#0B0B0D]/60 backdrop-blur-[2px] z-10 flex flex-col items-center justify-center">
                ...
                <p className="text-[#A9A6B0] mt-3 text-sm text-center px-6">Bank disbursements launching soon</p>
              </div>
              ...
              <p className="text-[#A9A6B0]/50">Direct bank transfers to major Tanzanian banks.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 lg:px-[8vw]">
        <div className="text-center mb-12">
          ...
          <h2 className="text-[clamp(28px,3.5vw,44px)] font-bold text-[#F4F1EC] mb-4">
            Manage all payouts in <span className="text-[#C9A45C]">one place</span>
          </h2>
          <p className="text-lg text-[#A9A6B0] max-w-2xl mx-auto">
            Track disbursements, manage bulk payouts, and generate reports from your intuitive dashboard.
          </p>
        </div>
        ...
        <div ref={dashboardRef} className="relative max-w-5xl mx-auto">
          ...
          <div className="relative bg-[#141419] border border-[#2a2a30] rounded-3xl p-4 shadow-2xl">
            <img 
              src="/disb.webp" 
              alt="GCA Pay Disbursement Dashboard" 
      ...
      <section className="py-20 px-6 lg:px-[8vw]">
        <div className="text-center mb-16">
          ...
          <h2 className="text-[clamp(28px,3.5vw,44px)] font-bold text-[#F4F1EC] mb-4">
            Built for <span className="text-[#C9A45C]">every</span> payout need
          </h2>
        </div>

        <div ref={useCasesRef} className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {useCases.map((useCase, index) => (
            <div 
              key={index}
              className="group relative bg-[#141419] border border-[#2a2a30] rounded-3xl p-8 hover:border-[#C9A45C]/30 transition-all duration-300"
            >
              ...
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#C9A45C]/20 to-[#C9A45C]/5 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <useCase.icon className="w-7 h-7 text-[#C9A45C]" />
              </div>
              
              <h3 className="text-xl font-bold text-[#F4F1EC] mb-3">{useCase.title}</h3>
              <p className="text-[#A9A6B0] leading-relaxed">{useCase.description}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="py-20 px-6 lg:px-[8vw]">
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-[#C9A45C] to-[#A8843D] rounded-3xl p-12 text-center">
          <h2 className="text-3xl font-bold text-[#0B0B0D] mb-4">
            Ready to start disbursing payments?
          </h2>
          <p className="text-[#0B0B0D]/70 mb-8 max-w-xl mx-auto">
            Join businesses across Tanzania who trust GCA Pay for their payout needs.
          </p>
